...
//	private Toolbarbutton btnCrearSistemaArchivo;
	...
	public void doAfterCompose(Window winEscritorio) throws Exception{
		...
		/************************
		 <bandpopup>
										 	<groupbox>
										 		<caption label="${labels.codex.buscar.$}"></caption>
										 		<vbox>
										 			<hbox>
										 				<div width="150px">
										 					<label value="${labels.codex.nombre.$}" ></label>
										 				</div>
										 				<textbox id="txtBscNombre" width="200px"></textbox>
										 			</hbox>
										 			<hbox>
										 				<div width="150px">
										 				<label value="${labels.codex.sistema.serie}"></label>
										 				</div>
										 			...
										 			<hbox>
										 				<div width="150px">
										 					<label value="${labels.codex.descripcion.$}" ></label>
										 				</div>
