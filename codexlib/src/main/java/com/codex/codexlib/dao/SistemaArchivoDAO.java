package com.codex.codexlib.dao;
...
public class SistemaArchivoDAO extends PltDAO{
	...
	public List<DocSistArch> getHijosRaiz() throws Exception{
		...
		try{
			...
			String hql = "from com.codex.codexlib.bd.DocSistArch dir where dir.audiSiAnul = false and dir.docSistArch is null order by dir.sistArchNombre";
	...
	public List<DocSistArch> getHijos(DocSistArch padre) throws Exception{
		...
		try{
			...
			String hql = "from com.codex.codexlib.bd.DocSistArch dir where dir.audiSiAnul = false and dir.docSistArch = :padre order by dir.sistArchNombre";
